...
//  CassandraClient getClient();
  ...
  void insert(ByteBuffer key, ColumnPath columnPath, ByteBuffer value) throws HectorException;

  void insert(ByteBuffer key, ColumnPath columnPath, ByteBuffer value, long timestamp) throws HectorException;
