...
public class ThriftServiceImpl implements ThriftService {
  ...
  private static final Logger log = LoggerFactory.getLogger(ThriftServiceImpl.class);

  protected final String keyspaceName;

  protected final ConsistencyLevelPolicy consistency;

  protected final ExceptionsTranslator xtrans;

  protected final HConnectionManager connectionManager;

  protected CassandraHost cassandraHost;

  protected final FailoverPolicy failoverPolicy;
  
  protected final Map<String, String> credentials;

  public ThriftServiceImpl(String keyspaceName,
  ...
  @Override
  public void insert(ByteBuffer key, ColumnPath columnPath, ByteBuffer value) throws HectorException {
//    valideColumnPath(columnPath);
      ...
      insert(key, columnParent, column);
  }

  @Override
  public void insert(ByteBuffer key, ColumnPath columnPath, ByteBuffer value, long timestamp) throws HectorException {
//    valideColumnPath(columnPath);
      ColumnParent columnParent = new ColumnParent(columnPath.getColumn_family());
      if (columnPath.isSetSuper_column()) {
      columnParent.setSuper_column(columnPath.getSuper_column());
